 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Jun 20 08:25:22 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                volt_curr_delay
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vorigin of S-Function volt_curr_delay");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Iorigin of S-Function volt_curr_delay");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Vdelay of S-Function volt_curr_delay");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Idelay of S-Function volt_curr_delay");
      return;
    }
...
{
  const real_T *Vorigin = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Iorigin = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *Vdelay = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *Idelay = (real_T *) ssGetOutputPortRealSignal(S, 1);
  volt_curr_delay_Outputs_wrapper(Vorigin, Iorigin, Vdelay, Idelay);
}
