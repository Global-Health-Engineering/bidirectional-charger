 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Jun 20 08:17:49 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                pll_function
...
extern void pll_function_Start_wrapper(const real_T *Kp_pll, const int_T
  p_width0,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vac of S-Function pll_function");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port phase of S-Function pll_function");
      return;
    }
...
static void mdlStart(SimStruct *S)
{
  ...
  const real_T *Kp_pll = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  const real_T *Ki_pll = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *w_nom = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  pll_function_Start_wrapper(Kp_pll, p_width0, Ki_pll, p_width1, w_nom, p_width2);
}
...
{
  const real_T *Vac = (real_T *) ssGetInputPortRealSignal(S, 0);
  real_T *phase = (real_T *) ssGetOutputPortRealSignal(S, 0);
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const int_T p_width1 = mxGetNumberOfElements(PARAM_DEF1(S));
  const int_T p_width2 = mxGetNumberOfElements(PARAM_DEF2(S));
  const real_T *Kp_pll = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  const real_T *Ki_pll = (const real_T *) mxGetDoubles(PARAM_DEF1(S));
  const real_T *w_nom = (const real_T *) mxGetDoubles(PARAM_DEF2(S));
  pll_function_Outputs_wrapper(Vac, phase, Kp_pll, p_width0, Ki_pll, p_width1,
    w_nom, p_width2);
}
