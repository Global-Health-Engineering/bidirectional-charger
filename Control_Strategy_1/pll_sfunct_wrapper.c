...
static double Ts = 5e-6;               // Sampling time (50 µs)
static double wn = 2.0 * M_PI * 60.0;  // Nominal frequency (rad/s)
 ...
 *
 */
extern void pll_sfunct_Start_wrapper(void);

void pll_sfunct_Start_wrapper(void)
{
 ...
 *
 */
extern void pll_sfunct_Outputs_wrapper(const real_T *Vac,
			real_T *phase);

void pll_sfunct_Outputs_wrapper(const real_T *Vac,
			real_T *phase)
{
