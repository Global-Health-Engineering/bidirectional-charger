 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Aug 08 12:11:47 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                pll_sfunct
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vac of S-Function pll_sfunct");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port phase of S-Function pll_sfunct");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  pll_sfunct_Outputs_wrapper(Vac, phase);
}
